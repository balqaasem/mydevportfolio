  ...
  return (
    <>
        ...
        <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight'>
          ...
          <Skill name="Management" x="23vw" y="-20vw"/>
          <Skill name="Research" x="10vw" y="-20vw"/>
          <Skill name="FullStack" x="-2vw" y="-20vw"/>
          <Skill name="BackEnd"  x="-13vw" y="-20vw"/>
          <Skill name="FrontEnd" x="-24vw" y="-20vw"/>

          <Skill name="Flutter" x="29vw" y="-15vw"/>
          <Skill name="TailwindCSS" x="17.5vw" y="-15vw"/>
          <Skill name="CSS" x="7vw" y="-15vw"/>
          ...
          <Skill name="AWS" x="11vw" y="10vw"/>
          <Skill name="Solidity" x="1vw" y="10vw"/>
          <Skill name="MongoDB" x="22vw" y="10vw"/>
          ...
          <Skill name="Webpack" x="6.5vw" y="15vw"/>
          <Skill name="Dart" x="19vw" y="15vw"/>

          <Skill name="AI/ML" x="-22vw" y="20vw"/>
          <Skill name="Web3"  x="-12.3vw" y="20vw"/>
          <Skill name="Cross-Platform" x="0vw" y="20vw"/>
