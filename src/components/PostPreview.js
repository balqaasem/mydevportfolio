...
const PostPreview = ({ title, date, subtitle, slug, topic, tags, onClick }) => {
  return (
    <div className="border border-solid border-dark dark:border-light p-4 rounded-md shadow-sm bg-light dark:bg-dark">
      ...
      <p className="text-sm font-bold text-primaryGreenDark dark:text-primaryDark mb-2">Topic: {topic}</p>
